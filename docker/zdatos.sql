...
INSERT INTO `resbar`.`Orden` (`idOrden`, `mesero`,`mesa`,`cliente`,`fecha`,`comentario`,`total`,`estado`) VALUES (03, 'Xiomara','M4','andrea','2018-05-20','doble porcion de papas',21.0000,1);
INSERT INTO `resbar`.`Orden` (`idOrden`, `mesero`,`mesa`,`cliente`,`fecha`,`comentario`,`total`,`estado`) VALUES (04, 'Luis','M5','David','2018-05-21','tortilla extra',21.0000,1);
